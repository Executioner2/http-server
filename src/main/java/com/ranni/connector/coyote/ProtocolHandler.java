...
import com.ranni.connector.coyote.http11.Http11Nio2Protocol;
...
//                || (!apr && Http11NioProtocol.class.getName().equals(protocol))) {
//            
...
//        }
        ...
        // XXX - 固定返回Http11协议的NIO2处理器
        return new Http11Nio2Protocol();
    }
