...
public final class UDecoder {
    ...
    private static final IOException EXCEPTION_EOF = new DecodeException("uDecoder.eof");
    ...
    public final String convert(String str, boolean query)
    {
        ...
        while (strPos < strLen) {
            ...
            if (metaChar == '+') {
                ...
                if (noSlash && (res == '/')) {
                    throw new IllegalArgumentException("uDecoder.noSlash");
                }
                dec.append(res);
                strPos += 3;
            }
        ...
        try {
            while (ix < len) {
                ...
                if (c == '%') {
                    osw.flush();
                    if (ix + 2 > len) {
                        throw new IllegalArgumentException("uDecoder.urlDecode.missingDigit" + str);
                    }
            ...
            throw new IllegalArgumentException("uDecoder.urlDecode.conversionError" + str 
                    + charset.name(), ioe);
        }
    }
