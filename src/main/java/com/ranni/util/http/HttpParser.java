        ...
        do {
            ...
            if (c == '.') {
                if (octet > -1 && octet < 256) {
                    ...
                    throw new IllegalArgumentException("http.invalidOctet" + Integer.toString(octet));
                } else {
                ...
                throw new IllegalArgumentException("http.illegalCharacterIpv4" + ((char) c));
            }
            pos++;
        } while (true);
    ...
    static int readHostIPv6(Reader reader) throws IOException {
        ...
        do {
            ...
            if (HttpParser.isHex(c)) {
                ...
                throw new IllegalArgumentException("http.illegalCharacterIpv6" + ((char) c));
            }
            pos++;
        } while (true);

        if (h16Count > 8) {
            throw new IllegalArgumentException("http.tooManyHextets" + h16Count);
        } else if (h16Count != 8 && !parsedDoubleColon) {
            throw new IllegalArgumentException("http.tooFewHextets" + h16Count);
        }
        ...
        if (c == ':') {
            ...
            throw new IllegalArgumentException("http.illegalAfterIpv6" + ((char) c));
        }
    }
        ...
        public DomainParseState next(int c) {
            if (c == -1) {
                if (allowsEnd) {
                    ...
                    throw new IllegalArgumentException("http.invalidSegmentEndState" + this.name());
                }
                ...
                if (allowsPeriod) {
                    ...
                    throw new IllegalArgumentException(errorMsg + ((char) c));
                }
            } else if (c == ':') {
                if (allowsEnd) {
                    return COLON;
                ...
                throw new IllegalArgumentException("http.illegalCharacterDomain" + ((char) c));
            }
        }
    }
}
